...
$_SSS['app']['tenant_folder'] = 'tenant_2'; //folder name
$_SSS['app']['app_folder'] = 'ci_app'; //folder name
$_SSS['app']['asset_folder'] = 'tenant_2_asset'; //folder name with a trailing slash only if there is an asset folder else leave blank
